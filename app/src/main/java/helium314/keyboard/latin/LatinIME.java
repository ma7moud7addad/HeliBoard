...
import com.macboard.keyboard.compat.EditorInfoCompatUtils;
import com.macboard.keyboard.compat.ImeCompat;
import com.macboard.keyboard.event.HapticEvent;
import com.macboard.keyboard.keyboard.KeyboardActionListener;
import com.macboard.keyboard.keyboard.KeyboardActionListenerImpl;
import com.macboard.keyboard.keyboard.emoji.EmojiPalettesView;
import com.macboard.keyboard.keyboard.emoji.EmojiSearchActivity;
...
import com.macboard.keyboard.latin.common.InsetsOutlineProvider;
import com.macboard.keyboard.dictionarypack.DictionaryPackConstants;
import com.macboard.keyboard.event.Event;
import com.macboard.keyboard.event.InputTransaction;
...
import com.macboard.keyboard.latin.common.ViewOutlineProviderUtilsKt;
import com.macboard.keyboard.latin.define.DebugFlags;
import com.macboard.keyboard.latin.inputlogic.InputLogic;
import com.macboard.keyboard.latin.personalization.PersonalizationHelper;
...
import com.macboard.keyboard.latin.suggestions.SuggestionStripViewAccessor;
import com.macboard.keyboard.latin.touchinputconsumer.GestureConsumer;
import com.macboard.keyboard.latin.utils.ColorUtilKt;
import com.macboard.keyboard.latin.utils.FloatingKeyboardUtils;
import com.macboard.keyboard.latin.utils.FoldableUtils;
import com.macboard.keyboard.latin.utils.GestureDataGatheringKt;
import com.macboard.keyboard.latin.utils.GestureDataGatheringSettings;
import com.macboard.keyboard.latin.utils.InlineAutofillUtils;
import com.macboard.keyboard.latin.utils.InputMethodPickerKt;
import com.macboard.keyboard.latin.utils.JniUtils;
import com.macboard.keyboard.latin.utils.KtxKt;
import com.macboard.keyboard.latin.utils.LeakGuardHandlerWrapper;
...
import com.macboard.keyboard.latin.utils.StatsUtilsManager;
...
public class LatinIME extends InputMethodService implements
    ...
    public LatinIME() {
        ...
        mKeyboardActionListener = new KeyboardActionListener() {
            ...
            // --- الدالة اللي كانت ناقصة وعملت المشكلة كلها ---
            @Override
            public boolean commitImage(android.net.Uri uri) {
                return delegate.commitImage(uri);
            }
            // -------------------------------------------------
        };
    ...
    private void workaroundForHuaweiStatusBarIssue() {
        ...
        if (Build.VERSION.SDK_INT == 31 && "HUAWEI".equalsIgnoreCase(Build.MANUFACTURER)) {
